...
public class AccDeletionSuccessfully extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AccDeletionSuccessfully frame = new AccDeletionSuccessfully();
	 ...
	 * Create the frame.
	 */
	public AccDeletionSuccessfully() {
		...
		JLabel Label_1 = new JLabel("Account Deleted!");
		Label_1.setFont(new Font("Tahoma", Font.PLAIN, 35));
		Label_1.setBounds(57, 0, 266, 61);
		MessageBox_LogIn.add(Label_1);
		
		JLabel Label_2 = new JLabel("Account has been “DELETED” ");
		Label_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		Label_2.setBounds(57, 38, 269, 61);
