...
public class DeletingAccount extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeletingAccount frame = new DeletingAccount();
	...
	public DeletingAccount() {
		...
		JLabel Label_1 = new JLabel("Deleting An Account");
		...
		Label_2.setBounds(18, 40, 332, 61);
		...
		JLabel Label_3 = new JLabel("an existing Account?");
		Label_3.setFont(new Font("Tahoma", Font.PLAIN, 20));
		Label_3.setBounds(94, 71, 193, 61);
